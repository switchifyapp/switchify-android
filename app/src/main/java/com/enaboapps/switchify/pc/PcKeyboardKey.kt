...
val PC_SHORTCUT_TARGET_KEYS: List<PcKeyboardShortcutKey> = listOf(
    PcKeyboardShortcutKey.F1,
    PcKeyboardShortcutKey.F2,
    PcKeyboardShortcutKey.F3,
    PcKeyboardShortcutKey.F4,
    PcKeyboardShortcutKey.F5,
    PcKeyboardShortcutKey.F6,
    PcKeyboardShortcutKey.F7,
    PcKeyboardShortcutKey.F8,
    PcKeyboardShortcutKey.F9,
    PcKeyboardShortcutKey.F10,
    PcKeyboardShortcutKey.F11,
