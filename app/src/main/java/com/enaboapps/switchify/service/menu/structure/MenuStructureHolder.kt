...
import com.enaboapps.switchify.service.menu.menus.recentapps.RecentAppsMenuStructure
...
class MenuStructureHolder(accessibilityService: SwitchifyAccessibilityService) {
    ...
    private val recentAppsMenuStructure = RecentAppsMenuStructure(accessibilityService)
    ...
    // Recent Apps Menu
    fun buildRecentAppsMenuObject() = recentAppsMenuStructure.buildRecentAppsMenuObject()
}
